...
gulp.task('sass', function() {
  return gulp.src('wp-content/themes/photography/styles/**/*.scss') // Gets all files ending with .scss in app/scss and children dirs
    .pipe(sass())
    .pipe(gulp.dest('wp-content/themes/photography/styles/compiled'))
});

gulp.task('sass:watch', function () {
  gulp.watch('wp-content/themes/photography/styles/**/*.scss', gulp.series(['sass']));
}); 
...
add_shortcode('aboutPage', 'about_page');

function investment_page() {
  include 'investment.php';
}

add_shortcode('investmentPage', 'investment_page');

function at_haessly_page() {
  include 'at-haessly.php';
}

add_shortcode('atHaesslyPage', 'at_haessly_page');

function extra_extra_page() {
  include 'extra-extra.php';
}

add_shortcode('extraExtraPage', 'extra_extra_page');